    ...
    <section id="view-login">
        <div class="row" style="padding-bottom: 5em">
            <div class="col-xs-12 col-md-4 col-md-offset-4">
                {!! Form::open(['url'=>'post/login','method'=>'POST','autocomplete'=>'off']) !!}
                ...
                <div title="Únete al equipo, boletin y mas" style="text-align: center"><p><span>Join Team, Newsletter and More</span></p></div>
                <div class="form-group {{ $errors->has('email') ? ' has-error' : '' }}">
                    <input title="correo" name="email" type="email" class="form-control" placeholder="E-mail" required
                           value="{{ old('email') }}">
                    @if ($errors->has('email'))
                ...
                <div class="form-group {{ $errors->has('password') ? ' has-error' : '' }}">
                    <div class="input-group">
                        <input title="contraseña" id="txtPassword" name="password" type="password" class="form-control"
                               placeholder="Password" maxlength="16" required>
                        <div class="input-group-btn">
                            <a title="mostrar/ocultar contraseña" type="button" href
                               class="btn btn-link btnEyesPassword"><i class="fa fa-eye"></i></a>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-xs-6 col-md-6">
                            <div class="checkbox">
                                <label>
                                    <input title="recordarme" type="checkbox"
                        ...
                        <div class="col-xs-6 col-md-6 text-right">
                            <div class="checkbox">
                                <a title="recuperar contraseña" href="{{ url('/password/reset') }}"><span
                                            style="font-size: small">Recover Password</span></a>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="form-group text-center">
                    ...
                    <a title="registrate" href="{{ url('/socialite/register') }}" class="button big btn-block">Sign
                        In</a>
                </div>
                <div class="form-group text-center">
