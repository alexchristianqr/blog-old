                    ...
                    <div class="panel-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 text-right">
                                    <div class="form-group">
                                        ...
                                        <button id="activate-step-2" class="btn btn-primary"><i
                        ...
                        <div class="form-group">
                            <div class="col-md-4 col-md-offset-4">
                                <div class="thumbnail">
                                    <img src="{{ old('avatar',isset($data->avatar)?$data->avatar:'') }}" alt="profile"
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <p>Edad</p>
                                    {!! Form::text('age',old('age'),['class'=>'form-control','placeholder'=>'>= 18','required']) !!}
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select name="id_sector" id="" class="form-control">
                            ...
                            <div class="col-md-8">
                                <div class="form-group">
                                    ...
                                    <p>Observación</p>
                                    <textarea name="observation" id="" cols="30" rows="1" class="form-control"
                                              placeholder=" * Field Optional"></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
