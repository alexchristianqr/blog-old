        ...
        <div class="end-publicado">
            <div class="meta">
                ...
                <a href="#" class="author" style="padding-bottom: 1em">
                    <span class="name"><span class="to-lowercase">publicado por&nbsp;</span>{{ $data->user_name }}</span>
                                ...
                                <article class="mini-post">
                                    <header style="padding: 0;">
                                        <div style="padding: 1em !important;text-align: left;">
                                            <a href="{{ url('post/show',['id' => $value->id,'id_tipo_post'=>$value->id_tipo_post]) }}" class="button-inverse">ver post</a>
                                        </div>
                                    </header>
                                    <header>
                                        <h3 style="min-height:36px;max-height: 50px;"><a href="#">{{ $value->title }}</a></h3>
